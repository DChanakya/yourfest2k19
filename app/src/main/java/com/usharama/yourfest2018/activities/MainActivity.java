...
public class MainActivity extends AppCompatActivity
    ...
    LinearLayout technicalButton, culturalButton, registerButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        technicalButton = (LinearLayout) findViewById(R.id.technical_button);
        culturalButton = (LinearLayout) findViewById(R.id.cultural_button);
        registerButton = (LinearLayout) findViewById(R.id.register_button);
        final Intent technicalIntent=new Intent(this,Technical.class);
        final Intent culturalIntent=new Intent(this,Cultural.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cultural) {
            Intent intent=new Intent(this,Cultural.class);
            startActivity(intent);
